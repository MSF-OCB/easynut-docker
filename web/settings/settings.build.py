...
Used by the dockerfile to build the image in dev environment (function collectstatic)
...
# The variables noted here are wrong, they are not used by "collectstatic"
